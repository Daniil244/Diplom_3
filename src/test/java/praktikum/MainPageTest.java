...
public class MainPageTest {
    ...
    public void testSauceSectionButton() {
        ...
        Assert.assertTrue("Sauce selection button is not working",
                mainPage.isSauceSectionSelected());
    }

    @Test
    @DisplayName("Проверка кнопки - булки")
    public void testBunSectionButton() throws InterruptedException {
        mainPage.open();
        mainPage.waitForLoad();
        ...
        Thread.sleep(60000);
        Assert.assertTrue("Bun selection button is not working",
    ...
    public void testFillingSectionButton() {
        ...
        Assert.assertTrue("Filling selection button is not working",
                mainPage.isFillingSectionSelected());
    }
}
