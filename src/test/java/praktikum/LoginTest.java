...
public class LoginTest {
    ...
    public void testLoginByEnterAccountButton() {
        ...
        Assert.assertTrue("Login by account button failed",
    ...
    public void testLoginByProfileLink() {
        ...
        Assert.assertTrue("Login by profile button failed",
                mainPage.isOrderButtonVisible());
    }
    ...
    public void testLoginOnRegistrationPage() {
        ...
        Assert.assertTrue("Login throw register form failed",
                mainPage.isOrderButtonVisible());
    }
    ...
    public void testLoginOnPasswordRecoveryPage() {
        ...
        Assert.assertTrue("Login throw forgot password page failed",
                mainPage.isOrderButtonVisible());
    }
